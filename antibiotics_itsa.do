...
est store full
outreg2 full using itsa_monthly, replace ci dec(4) sideway noaster noparen nonotes
...
est store full
outreg2 full using itsa_long_term, replace ci dec(4) sideway noaster noparen nonotes
